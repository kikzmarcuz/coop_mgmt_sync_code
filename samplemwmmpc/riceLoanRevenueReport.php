...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($searchReport == "searchReport" or $printReport == "printReport"){
        ...
        if($printReport == "printReport"){
            ...
            $pdf->Cell(15,7,"IN #",1);
            $pdf->Cell(5,7,"#",1);
            $pdf->Cell(20,7,"PRINCIPAL",1);
            $pdf->Cell(20,7,"INTEREST",1);
            ...
            while($rowCounter < $numRow) {
                ...
                $pdf->Cell(5,7,"$quantity[$rowCounter]",1);
                $pdf->Cell(20,7,number_format($principalAmount[$rowCounter], 2, '.', ','),1);
                $pdf->Cell(20,7,number_format($interestAmount[$rowCounter], 2, '.', ','),1);
                $totalValue = $interestAmount[$rowCounter] + $principalAmount[$rowCounter];
                $totalSale = $totalSale + $totalValue;
                $pdf->Cell(25,7,number_format($totalSale, 2, '.', ','),1);
                $pdf->Ln();
            ...
            $pdf->Cell(45,7,number_format($totalAR, 2, '.', ','),1);
            $pdf->Cell(45,7,number_format($totalIR, 2, '.', ','),1);
            $pdf->Cell(30,7,number_format($totalRLSale, 2, '.', ','),1);
            ...
            $pdf->Cell(45,7,number_format($totalCSDR, 2, '.', ','),1);
            $pdf->Cell(45,7,number_format($totalIIDR, 2, '.', ','),1);
            $pdf->Cell(30,7,number_format($totalRCSale, 2, '.', ','),1);
            ...
            $pdf->Cell(45,7,number_format($totalPrincipal, 2, '.', ','),1);
            $pdf->Cell(45,7,number_format($totalInterest, 2, '.', ','),1);
            $pdf->Cell(30,7,number_format($totalSale, 2, '.', ','),1);
                ...
                <div class="table table-striped table-hover">
                    ...
                    echo "</tr>";
                     ...
                     echo "<tr>";
                        ...
                        echo "<th>" ."" . "</th>";
                        echo "<th>" . "Quantity" . "</th>";
                        echo "<th>" . "Account Receivable" . "</th>";
                        echo "<th>" . "Interest Receivable" . "</th>";
                        echo "<th>" . "Sale CR". "</th>";
                    echo "</tr>";

                     echo "<tr>";
                        echo "<th>" . "Rice Loan Sale" . "</th>";
                        echo "<th>" . "Total" . "</th>";
                        echo "<th>" . "" . "</th>";
                        echo "<th>" . "" . "</th>";
                        echo "<th>" ."" . "</th>";
                        echo "<th " . "style=" . "color:green" . ">" . $totalRLQuantity . "</th>";
                        echo "<th " . "style=" . "color:green" . ">" . number_format($totalAR, 2, '.', ',') . "</th>";
                        echo "<th " . "style=" . "color:green" . ">" . number_format($totalIR, 2, '.', ',') . "</th>";
                        echo "<th " . "style=" . "color:green" . ">" . number_format($totalRLSale, 2, '.', ','). "</th>";
                    echo "</tr>";
                    ...
                    echo "<tr>";
                        ...
                        echo "<th>" ."" . "</th>";
                        echo "<th>" . "Quantity" . "</th>";
                        echo "<th>" . "Cash Sale DR" . "</th>";
                        echo "<th>" . "Interest Income DR" . "</th>";
                        echo "<th>" . "Sale CR". "</th>";
                    echo "</tr>";

                    echo "<tr>";
                        echo "<th>" . "Rice Cash Sale" . "</th>";
                        echo "<th>" . "Total" . "</th>";
                        echo "<th>" . "" . "</th>";
                        echo "<th>" . "" . "</th>";
                        echo "<th>" ."" . "</th>";
                        echo "<th " . "style=" . "color:blue" . ">" . $totalRCQuantity . "</th>";
                        echo "<th " . "style=" . "color:blue" . ">" . number_format($totalCSDR, 2, '.', ',') . "</th>";
                        echo "<th " . "style=" . "color:blue" . ">" . number_format($totalIIDR, 2, '.', ',') . "</th>";
                        echo "<th " . "style=" . "color:blue" . ">" . number_format($totalRCSale, 2, '.', ','). "</th>";
                    echo "</tr>";
                    ...
                    echo "<tr>";
                        ...
                        echo "<th>" . "" . "</th>";
                        echo "<th>" ."" . "</th>";
                        echo "<th " . "style=" . "color:orange" . ">" . $totalQuantity . "</th>";
                        echo "<th " . "style=" . "color:orange" . ">" .  number_format($totalP, 2, '.', ',') . "</th>";
                        echo "<th " . "style=" . "color:orange" . ">" .  number_format($totalI, 2, '.', ',') . "</th>";
                        echo "<th " . "style=" . "color:orange" . ">" .  number_format($totalSale, 2, '.', ',') . "</th>";
                    echo "</tr>";
                    ?>
                </div>
            </div>
