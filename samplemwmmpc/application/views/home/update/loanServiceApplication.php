    ...
    if($submitApplication == "submitApplication"){
        if ($countErr <= 0) {
            if($loanServiceName == "Emergency Loan"){
                ...
                $sql = "INSERT INTO rice_loan_table(id_number, loan_application_number, loan_service_id, invoice_number ,quantity, loan_amount, loan_term, loan_interest, payment_term,loan_status) 
                        VALUES ('$idNumber','$loanApplicationNumber','$loanServiceId', '$invoiceNumber' ,'$riceQuantity','$loanAmount','$loanTerm', '$loanInterest','$paymentTerm','Released')";
            }else{
