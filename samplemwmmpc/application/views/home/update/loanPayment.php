...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($searchMember == "searchMember" or $loanApplicationNumberId != "" or $typePayment != "") {
        # search member...
        ...
        if($countErr<=0){
            ...
            if(substr("$blLA",0,2) == "BL" and $blPayment != 0){
                ...
                $sql = "INSERT INTO bl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumber','$referencenumber','$blLA','$currentPrincipal','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO bl_credit_revenue_table(id_number,loan_application_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumber','$blLA','$referencenumber','$currentInterest','$datePayment', '$encodedBy')";
            ...
            if(substr("$cmlLA",0,3) == "CML" and $cmlPayment != 0){
                ...
                $sql = "INSERT INTO cml_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumber','$referencenumber','$cmlLA','$currentPrincipal','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO cml_credit_revenue_table(id_number,loan_application_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumber','$cmlLA','$referencenumber','$currentInterest','$datePayment', '$encodedBy')";
            ...
            if(substr("$edlLA",0,3) == "EDL" and $edlPayment != 0){
                ...
                $sql = "INSERT INTO edl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumber','$referencenumber','$edlLA','$currentPrincipal','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO edl_credit_revenue_table(id_number,loan_application_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumber','$edlLA','$referencenumber','$currentInterest','$datePayment', '$encodedBy')";
            ...
            if(substr("$rlLA",0,2) == "RL" and $rlPayment != 0){
                ...
                $sql = "INSERT INTO rl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumber','$referencenumber','$rlLA','$currentPrincipal','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO rl_credit_revenue_table(id_number,loan_application_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumber','$rlLA','$referencenumber','$currentInterest','$datePayment', '$encodedBy')";
            ...
            if(substr("$plLA",0,2) == "PL" and ($plPayment != 0 or $pliPayment !=0)){
                ...
                */
                ...
                $sql = "INSERT INTO pl_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumber','$referencenumber','$plLA','$plPayment','$datePayment', '$encodedBy')";
                ...
                $sql1 = "INSERT INTO pl_credit_revenue_table(id_number,loan_application_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumber','$plLA','$referencenumber','$pliPayment','$datePayment', '$encodedBy')";
            ...
            if($timeDeposit != 0){
                ...
                $sql5 = "INSERT INTO time_deposit_table(id_number, type_transaction, type_savings,reference_number,amount, date_transaction, encoded_by) 
                    VALUES ('$idNumber','$withdrawTimeDeposit','TD','$referencenumber','$timeDeposit','$datePayment','$encodedBy')";
            ...
            if($loanApplicationNumberP == "" and  $rcfPayment != 0){
                ...
                $sql = "INSERT INTO rice_cash_revenue_table(id_number, invoice_number , or_number,quantity, principal_amount,interest_amount, date_transaction,encoded_by) 
                    VALUES ('$idNumber','$invoiceNumber' , '$referencenumber' ,'$quantity','$rcfPayment', $rcfPaymentI,'$datePayment', '$encodedBy')";
                if ($conn->query($sql) === TRUE) {
                   $infomessage = "Record updated successfully";
            ...
            if($totalPayment != 0){
                ...
                $sql5 = "INSERT INTO cashier_report_table( id_number ,or_number, total_amount, bl, cll, cml, edl, rl, pl, cl, ckl, eml, sl, rcl, rcc, oi, sc, sd, td, fd ,date_transaction, encoded_by) 
                    VALUES ('$idNumber', '$referencenumber','$totalPayment', '$bl', '$cll','$cml','$edl','$rl','$pl','$cl','$ckl','$eml','$sl','$rcl','$rcc','$oi','$sc','$sd','$td','$fd','$datePayment','$encodedBy')";
            ...
            <div class="col-sm-12" style="margin-top:25px;margin-left: 16.7%;margin-bottom: 200px;">  
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1.5" style="background-color:#fff; padding: 2.5px; margin: 2.5px">
                        ...
                        <select onchange ="viewAmount()" style="width: 140px" id="top" name = "typePayment">
                          ...
                          <option value="othi" <?php if($otherIncome == "othi") echo "selected"; ?>>Other Income</option>
                        </select><br>
                    ...
                    <div class="col-lg-2.5" style="background-color:#fff; padding: 2.5px; margin: 2.5px">
                        ...
                        <input style="width: 75px" id = "rcfp" type="text" value = "<?php echo number_format($rcfPayment,'2','.','');?>" name="rcfPayment" readonly><br>
                        <label style="width: 120px">Rice (Interest)</label>  
                        <input style="width: 75px" id = "rcfi" type="text" value = "<?php echo number_format($rcfPaymentI,'2','.','');?>" name="rcfPaymentI" readonly>

                        <h6>Rice Loan</h6>
                        <input style="width: 120px" type="text" value = "Invoice Number" name="Invoice Number" readonly>
                    ...
                    <div class="col-lg-2.5" style="background-color:#fff; padding: 2.5px; margin: 2.5px">
                        ...
                        <input style="width: 75px" id = "bl" type="text" value = "<?php echo number_format($blPayment,'2','.','');?>" name="blPayment" readonly><br>
                        ...
                        <input style="width: 75px" id = "cml" type="text" value = "<?php echo number_format($cmlPayment,'2','.','');?>" name="cmlPayment" readonly><br>
                        ...
                        <input style="width: 75px" id = "edl" type="text" value = "<?php echo number_format($edlPayment,'2','.','');?>" name="edlPayment" readonly><br>
                        ...
                        <input style="width: 75px" id = "rl" type="text" value = "<?php echo number_format($rlPayment,'2','.','');?>" name="rlPayment" readonly><br>
                        <input style="width: 120px" id = "pll" type="text" value = "<?php echo $plLA;?>" name="plLA" readonly>   
                        <input style="width: 75px" id = "pl" type="text" value = "<?php echo number_format($plPayment,'2','.','');?>" name="plPayment" readonly><br>
                        <input style="width: 120px" id = "plil" type="text" value = "Previous Loan (I)" name="pliLA" readonly>   
                        <input style="width: 75px" id = "plif" type="text" value = "<?php echo number_format($pliPayment,'2','.','');?>" name="pliPayment" readonly><br><br>
                    </div>

                    <div class="col-lg-2.5" style="background-color:#fff; padding: 2.5px; margin: 2.5px">
                        <h6>Other Payment</h6>
                        <label style="width: 140px">Membership:</label>  
                        <input style="width: 75px" id = "mbf" type="text" value = "<?php echo number_format($mbfPayment,'2','.','');?>" name="mbfPayment" readonly><br>
                        <label style="width: 140px">Subscribe Capital:</label>   
                        <input style="width: 75px" id = "scf" type="text" value = "<?php echo number_format($scfPayment,'2','.','');?>" name="scfPayment" readonly><br>
                        <label style="width: 140px">Capital Build Up:</label>  
                        <input style="width: 75px" id = "cbu" type="text" value = "<?php echo number_format($cbuDeposit,'2','.','');?>" name="cbuDeposit" readonly>
                        <label> W </label>
                        <input id="wsc" type="checkbox" value = "Withdraw" name = "withdrawShareCapital"><br>
                        <label style="width: 140px">Savings:</label>  
                        <input style="width: 75px" id = "sdf" type="text" value = "<?php echo number_format($savingsDeposit,'2','.','');?>" name="savingsDeposit" readonly>
                        <label> W </label>
                        <input id = "wsd" type="checkbox" value = "Withdraw" name = "withdrawSavings"><br>
                        <label style="width: 140px">Time Deposit:</label>  
                        <input style="width: 75px" id = "tdp" type="text" value = "<?php echo number_format($timeDeposit,'2','.','');?>" name="timeDeposit" readonly>
                        <label> W </label>
                        ...
                        <input style="width: 75px" id = "msf" type="text" value = "<?php echo number_format($msfPayment,'2','.','');?>" name="msfPayment" readonly><br><br>
                    </div>

                    <div class="col-lg-2.5" style="background-color:#fff; padding: 2.5px; margin: 2.5px">
                        <h6>Other Income</h6>
                        <label style="width: 140px">Photocopy:</label>  
                        <input style="width: 75px" id = "ptf" type="text" value = "<?php echo number_format($ptfPayment,'2','.','');?>" name="ptfPayment" readonly><br>
                        <label style="width: 140px">Rental Income:</label>  
                        <input style="width: 75px" id = "rif" type="text" value = "<?php echo number_format($rifPayment,'2','.','');?>" name="rifPayment" readonly><br>
                        <label style="width: 140px">Rental Receivable:</label>  
                        <input style="width: 75px" id = "rrf" type="text" value = "<?php echo number_format($rrfPayment,'2','.','');?>" name="rrfPayment" readonly><br>
                        <label style="width: 140px">Transfer Fee:</label>  
                        <input style="width: 75px" id = "tff" type="text" value = "<?php echo number_format($tffPayement,'2','.','');?>" name="tffPayement" readonly><br>
                        <label style="width: 140px">Insurance:</label>  
                        <input style="width: 75px" id = "inf" type="text" value = "<?php echo number_format($infPayment,'2','.','');?>" name="infPayment" readonly><br>
                        <label style="width: 140px">Other Income:</label>  
                        <input style="width: 75px" id = "oif" type="text" value = "<?php echo number_format($rbfPayment,'2','.','');?>" name="rbfPayment" readonly><br>


                        <label style="width: 140px">TOTAL:</label>
                        <input style="width: 75px" id = "totalP" type="text" value = "<?php echo number_format($totalPayment,'2','.','');?>" name="totalPayment">
                    </div>
                                        ...
                                        if(substr("$loanApplicationNumberP", 0,3) == "RCL"){
                                            ...
                                            while($counterf < $counterPayment){
                                                ...
                                                echo "<tr>";
                                                    ...
                                                    $totalPrincipalA = $totalPrincipalA + $amountPaymentP[$counterf];
                                                    echo "<td>" . $amountPaymentP[$counterf] . "</td>";
                                                    $totalInterestA = $totalInterestA + $amountPI[$counterf];
                                            ...
                                            echo "<tr>";
                                                ...
                                                echo "<td>"  . "" . "</td>";
                                                echo "<td>"  . "" . "</td>";
                                                echo "<td>" . $totalPrincipalA . "</td>";
                                                echo "<td>" . $totalInterestA . "</td>";
                                                echo "<td>"  . "" . "</td>";
                                                echo "<td></td>";
                                            echo "</tr>";
                                        }else{
