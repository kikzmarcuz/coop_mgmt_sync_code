...
if($resultOR->num_rows > 0){
    ...
    while ($row = mysqli_fetch_array($resultOR)) {
        # code...
        $referencenumber = $row['journal_number'] + 1;
    }
}else{
    $referencenumber = 1;
}
    ...
    if($paidLoan == "paidLoan"){
        if($countErr<=0){
            ...
            if(substr("$blLA",0,2) == "BL" and $blPayment != 0){
                ...
                loan_status = 'Paid'
                WHERE loan_application_number = '$blLA'";
                ...
                $sql1 = "INSERT INTO bl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$blLA', '$voucherNumber' , '$checqueNumber' , '$loanApplicationNumberA','$blPaymentI','$monthDateR', '$encodedBy')";
            ...
            if(substr("$cmlLA",0,3) == "CML" and $emlPayment != 0){
                ...
                loan_status = 'Paid'
                WHERE loan_application_number = '$cmlLA'";
                ...
                $sql = "INSERT INTO cml_loan_payment_table(id_number, reference_number,loan_application_number, amount,date_payment, encoded_by) 
                    VALUES ('$idNumberA','$referencenumber','$cmlLA','$cmlPayment','$monthDateR', '$encodedBy')";

                $sql1 = "INSERT INTO cml_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$cmlLA', '$voucherNumber' , '$checqueNumber' , '$referencenumber','$cmlPaymentI','$monthDateR', '$encodedBy')";
            ...
            if(substr("$edlLA",0,3) == "EDL" and $edlPayment != 0){
                ...
                loan_status = 'Paid'
                WHERE loan_application_number = '$edlLA'";
                ...
                $sql1 = "INSERT INTO edl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$edlLA', '$voucherNumber' , '$checqueNumber' , '$loanApplicationNumberA','$edlPaymentI','$monthDateR', '$encodedBy')";
            ...
            if(substr("$rlLA",0,2) == "RL" and $rlPayment != 0){
                ...
                loan_status = 'Paid'
                WHERE loan_application_number = '$rlLA'";
                ...
                $sql1 = "INSERT INTO rl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$rlLA', '$voucherNumber' , '$checqueNumber' , '$loanApplicationNumberA','$rlPaymentI','$monthDateR', '$encodedBy')";
            ...
            if(substr("$plLA",0,2) == "PL" and $plPayment != 0){
                ...
                loan_status = 'Paid'
                WHERE loan_application_number = '$plLA'";
                ...
                $sql1 = "INSERT INTO pl_credit_revenue_table(id_number,loan_application_number, voucher_number, checque_number, reference_number,interest_revenue, date_transaction,encoded_by) 
                    VALUES ('$idNumberA','$plLA', '$voucherNumber' , '$checqueNumber' , '$loanApplicationNumberA','$pliPayment','$monthDateR', '$encodedBy')";
            ...
            if($bbfPayment != 0){
                $oi = 1;
                $sql5 = "INSERT INTO credit_table(or_number, id_number, account_code, amount, remarks ,date_transaction, encoded_by) 
                    VALUES ('$referencenumber','$idNumber','MB','$bbfPayment','Members Benefit Fund','$datePayment','$encodedBy')";
