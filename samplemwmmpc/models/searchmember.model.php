...
function getMemberInfoS($mid, $searchobj){
	$conn = dbconnection();
	...
	$sqlName.= " WHERE (CONCAT(first_name, ' ', last_name) LIKE '%$mid%' OR last_name LIKE '%$mid%' or  id_number = '$mid') and member_status='Active' ";
